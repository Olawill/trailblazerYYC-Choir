...
export const MusicPlayer = ({ title }: MusicPlayerProps) => {
  ...
  return (
    <div className="bg-black text-white rounded-lg p-4 w-full flex flex-col items-center gap-4 justify-center ">
      <h1 className="italic font-bold text-lg text-center">{title}</h1>

      <div className="w-full flex justify-center items-center">
        <span className="font-bold italic w-6 mr-4">
          {formatDuration(seekTime)}
        </span>
        <h3 className="w-2 font-bold">/</h3>
        <span className="font-bold italic w-6">{formatDuration(duration)}</span>
      </div>
